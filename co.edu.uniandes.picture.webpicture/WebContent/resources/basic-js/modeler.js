...
function showToolBar(cell) {
    ...
    el.on('toolbarItemClick', function (event, buttonClicked) {
        var command = buttonClicked.id // get the id of the button click
        if (command == 'editElementBtn') {
        ...
        } else if (command == 'deleteElementBtn') {
            removeCell(cell);
            $(".tool-container").remove();
        } else if (command == 'toTopElement') {
            sentToTop(cell);
        } else if (command == 'toBackElement') {
            sendToBack(cell);
        } else if (command == 'reSizeElementBtn') {
