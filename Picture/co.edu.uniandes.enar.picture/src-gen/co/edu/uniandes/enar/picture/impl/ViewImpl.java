 ...
 * <ul>
 *   <li>{@link co.edu.uniandes.enar.picture.impl.ViewImpl#getReferenceImplementation <em>Reference Implementation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ViewImpl extends InteractionElementImpl implements View
{
  /**
  ...
  {
    return PicturePackage.Literals.VIEW;
  }
  ...
  public void setReferenceImplementation(String newReferenceImplementation)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PicturePackage.VIEW__REFERENCE_IMPLEMENTATION, oldReferenceImplementation, referenceImplementation));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PicturePackage.VIEW__REFERENCE_IMPLEMENTATION:
